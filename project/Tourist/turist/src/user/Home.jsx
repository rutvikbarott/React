...
function Home() {
  ...
  const [prorptylist, setperotylist] = useState([])

  useEffect(() => {
    getproerty()
  }, [])

  const getproerty = async () => {
    const res = await axios.get("http://localhost:3000/packages/")
    setperotylist(res.data)
  }
      ...
      <div className="container-xxl py-5">
        <div className="container">
          ...
          <div className="row g-4 justify-content-center">
            ...
            {
              prorptylist && prorptylist.map((prorpty, index) => {
                const { id, url, price, city, days, person, desc } = prorpty
                return (
                  <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div className="package-item">
                      ...
                      <div className="d-flex border-bottom">
                        <small className="flex-fill text-center border-end py-2"><i className="fa fa-map-marker-alt text-primary me-2" />{city}</small>
                        <small className="flex-fill text-center border-end py-2"><i className="fa fa-calendar-alt text-primary me-2" />{days}</small>
                        <small className="flex-fill text-center py-2"><i className="fa fa-user text-primary me-2" />{person}</small>
                      </div>
